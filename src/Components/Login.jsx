...
const Login = () => {
	return (
		<section className="flex h-screen items-center">
			<div className="w-full lg:w-1/2 xl:w-2/5 shrink-0">
				<div className="2xl:pl-24 lg:pl-16 px-4 sm:px-6 lg:pr-4">
					...
					<form className="mt-14">
						...
						<button
							type="submit"
							className="font-semibold bg-yellow-cheva w-full sm:text-base text-sm p-3 sm:p-4 rounded-lg mt-8 2xl:mt-10 shadow-cheva"
						>
							Login now
						</button>
					</form>
			...
			<div className="grow shrink hidden justify-center items-center lg:flex">
				<img
					src="/src/assets/login-illustration.svg"
					alt="login-illustration.svg"
